...
# --- MISSION 3: WIRING (Updated with Socket Security) ---
...
# THE SOCKET FIX: 
# We use 'pda_var_run_t'. This is the standard Fedora label that 
# allows User Apps to talk to Root Daemons via a socket.
